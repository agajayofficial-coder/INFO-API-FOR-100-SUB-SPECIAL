# ------------------------------------------------------------
# Free Fire Account Info API — Credit: @AGAJAYOFFICIAL
# JOIN    : @AGAJAYOFFICIAL  FOR MORE SRC | API | BOT CODE | METHOD | 🛐
# Purpose : Fetch Free Fire profile details using UID (JWT + AES)
# Note    : THIS CODE MADE BY AGAJAYOFFICIAL — KEEP CREDIT
...
def get_jwt_token_sync(region):
    ...
    endpoints = {
        "IND": "https://raihan-access-to-jwt.vercel.app/token?uid=4422013059&password=9A14867BBA0091781F5BBAC54DDC945B7C3B317B5C35E01AA62BC67DD910F22F",
        "BD": "https://raihan-access-to-jwt.vercel.app/token?uid=4422013059&password=9A14867BBA0091781F5BBAC54DDC945B7C3B317B5C35E01AA62BC67DD910F22F",
        "PK": "https://raihan-access-to-jwt.vercel.app/token?uid=4422013059&password=9A14867BBA0091781F5BBAC54DDC945B7C3B317B5C35E01AA62BC67DD910F22F",
        "default": "https://raihan-access-to-jwt.vercel.app/token?uid=4422013059&password=9A14867BBA0091781F5BBAC54DDC945B7C3B317B5C35E01AA62BC67DD910F22F"
    }
...
def index():
    return jsonify({
        "message": "Free Fire Account Info API - AGAJAYOFFICIAL",
        "endpoint": "/info?uid=PLAYER_UID&region=REGION",
        "supported_regions": ["IND", "BD", "PK"],
